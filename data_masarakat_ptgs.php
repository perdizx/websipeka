...
?> 
                            ...
                            <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                                <div class="Appointment">
                                    ...
                                    <div class="book_btn d-none d-lg-block">
                                        <a href="logout.php" onclick="return confirm('Yakin Ingin Logout?')">ut <i class="fa fa-sign-out"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
    ...
    <table class="table1" align="center" width="100%">
		<tr>
			...
			<th>Alamat</th>
            <th>RT/RW</th>
            <th><a class="btn btn-dark" style="float:left;" href="tambah_data_masarakat_ptgs.php" role="button"><i class="fa fa-user-plus"></i> Tambah</a></th>
</tr>
<?php 
$batas =6;
...
<a onClick="return confirm('Yakin Ingin Menghapus?')" class="btn btn-danger" href="hapus_data_masarakat_ptgs.php?idd=<?php echo $data['id_masarakat'] ?>" role="button"><i class="fa fa-remove"></i>Hapus</a>
</form></td>
</tr>
<?php }}else{
...
<li class="page-item"><a class="page-link" style="color:blue">Halaman</a></li>
	...
	if ($i != $halaman){
		echo "<li class='page-item'><a class='page-link' href=\"data_masarakat_ptgs.php?halaman=$i\">$i</a></li>";
	}
	else{
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Kel Tanjungpura</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
