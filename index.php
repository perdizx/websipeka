                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://maps.app.goo.gl/nTsDNV8YwQyy2Zns6" style="color:white"><i class="fa fa-podcast"> Kelurahan TanjungPura Cek Lokasi Disini</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> Kel_tanjungpura@gmail.com</a></li>
