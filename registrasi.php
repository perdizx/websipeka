...
if (isset($_POST['simpan'])){
	...
	$user = $_POST ['user'];
	$pass = $_POST ['pass'];
	$tambah = mysqli_query ($conn, "INSERT INTO masarakat(nik,nama,alamat,rt_rw,tlp,username,password)VALUES('$nik','$nama','$alamat','$rtrw','$tlp','$user','$pass')");
	if($tambah){
        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                ...
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Desa Umbulan<br>
