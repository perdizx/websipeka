...
<td>
<a class="btn btn-success" href="edit_user_admin.php?id=<?php echo $data['id_petugas'] ?>" role="button"><i class="fa fa-pencil"></i> Edit</a>
<a onClick="return confirm('Yakin Ingin Menghapus?')" class="btn btn-danger" href="hapus_user_admin.php?idd=<?php echo $data['id_petugas'] ?>" role="button"><i class="fa fa-remove"></i>Hapus</a>
</td>
</tr>
<?php }}else{
